...
import pickle
import pandas as pd
from functions import create_features_from_df
# joblib file required
with open(r"C:\Users\Um Ar\PycharmProjects\Internship-2\Semi-Supervised_SVM\Custom deploy\N\Tfidf.pkl", 'rb') as data:
    tfidf = pickle.load(data)

with open(r"C:\Users\Um Ar\PycharmProjects\Internship-2\Semi-Supervised_SVM\Custom deploy\N\model.pkl", 'rb') as data2:
